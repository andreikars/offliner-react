...
export default function ManageProducts() {
    ...
    const loadProducts = async () => {
        const result = await axios.get("https://nine-clubs-wonder.loca.lt/api/products");
    ...
    const deleteProduct = async (id) => {
        await axios.delete(`https://nine-clubs-wonder.loca.lt/api/products/${id}`);
        loadProducts();
    };
    ...
    const addProduct = async (e) => {
        ...
        try {
            await axios.post("https://nine-clubs-wonder.loca.lt/api/products", formData, {
                headers: {
